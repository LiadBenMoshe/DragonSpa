...
public class appointment_editing2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (validate()) {
                    Toast.makeText(appointment_editing2.this,"add successful",Toast.LENGTH_LONG).show();
                    ...
                    startActivity(new Intent(com.example.dragonspa.appointment_editing2.this,appointments_editing.class));
                }else{
                    Toast.makeText(com.example.dragonspa.appointment_editing2.this,"register failed",Toast.LENGTH_LONG).show();
                }
            }
    ...
    private Boolean validate() {
        ...
        if (name.isEmpty() || Price.isEmpty()) {
            Toast.makeText(com.example.dragonspa.appointment_editing2.this, "please enter name and price", Toast.LENGTH_LONG).show();
        } else {
            ans = true;
        }
        return ans;
